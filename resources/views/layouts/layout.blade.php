    ...
    <header>
        <nav>
            ...
            <div class="nav ">
                ...
                <a href="#review" class="nav-item ">Отзывы</a>
            </div>
...
<div class="user_btn">
  ...
  <div class="collapse" id="account-collapse">
    <ul id="ul_user" class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
      <li><a href="{{ route('profile') }}" class="link-dark rounded">Профиль</a></li>
      <li><a href="{{ route('logout') }}" class="link-dark rounded">Выйти из аккаунта</a></li>
    </ul>
  </div>
</li>
...
@auth
  ...
  @endif
    @if (Auth::user()->isBroker())
      <a href="/add">Создать объявление</a>  
    @endif
@endauth
            ...
            <form method="post" action="{{ route('reg') }}">
              @csrf
                ...
                <div class="mb-3">
                  ...
                  <input type="tel" class="form-control" name="phone" id="phone" value="{{old('phone')}}" placeholder="Ваш номер телефона">
              </div>
                <div class="mb-3">
                    <label for="password" class="col-form-label">Пароль</label>
                    <input type="password" class="form-control" name="password" id="password" placeholder="Ваш пароль">
